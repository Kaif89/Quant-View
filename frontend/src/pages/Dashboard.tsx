...
function SignalRow({ ticker, name, signal, change, isLast, onClick }: SignalRowProps) {
  const badgeClass =
  ...
  return (
    <div
      onClick={onClick}
      className={`flex items-center justify-between py-3 px-3 -mx-3 rounded-xl cursor-pointer hover:bg-secondary/50 transition-colors ${!isLast ? 'border-b border-border/50' : ''}`}
    >
